...
export default function NewNote({
    setIsCreating, setActiveNoteId, fetchNotes
}) {
    ...
    return <div className="w-2/3 p-2 flex flex-col gap-2 absolute top-0 bottom-0 right-0">
        ...
        <div className="w-full flex justify-end">
            <button onClick={() => onSave()} className="py-1 px-3 rounded-full border-2 border-green-600 hover:bg-green-200 transition-all duration-300 ease-in-out">
                저장
            </button>
        </div>
    </div>
